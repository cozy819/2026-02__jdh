...
| 1-1 | `01-1.html` | 23 | 23 | 오리엔테이션 | 완성 · 한중 |
| 1-2 | `01-2.html` | 18 | 18 | 이론 | 완성 · 한중 |
| 2-1 | `02-1.html` | 26 | 26 | 이론 | 완성 · 한중 |
| 2-2 | `02-2.html` | 52 | 52 | 실습 | 완성 · 한중 |
| 3-1 | `03-1.html` | 38 | 38 | 이론 | 완성 · 한중 |
| 3-2 | `03-2.html` | 48 | 48 | 이론+실습 | 완성 · 한중 |
| 4-1 | `04-1.html` | 24 | 24 | 이론 | 완성 · 한중 |
| 4-2 | `04-2.html` | 22 | 22 | 실습(읽기) | 완성 · 한중 |
| 5-1 | `05-1.html` | 22 | 22 | 평가 안내 | 완성 · 한중 |
| 5-2 | `05-2.html` | 25 | 25 | 수행평가 1 | 완성 · 한중 |
...
**‘쪽’과 ‘A4’는 항상 같다.** `.page` 하나가 인쇄 한 장에 정확히 들어가도록 전체를 재분할했고, 한국어·중국어 두 상태 모두 헤드리스 크롬으로 렌더링해 확인했다. 13회 26개 차시 전체가 집필 완료되었고, 합계 **574쪽**이다(`index-nobrand.html`·별도배포 제외). **2-2(52쪽)와 3-2(48쪽)가 가장 길다.** 3-2는 이론(리스트·튜플·조건·반복·함수·딕셔너리)과 통합 실습을 한 차시에 합친 결과다. 수업 운영에서 부담이 되면 오개념 점검과 확인 문제 뒤가 이론/실습 경계이므로 거기서 잘라 두 차시로 나눌 수 있다.
